...
.method protected _resolveInnerClassValuedProperty(Lcom/fasterxml/jackson/databind/DeserializationContext;Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;)Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;
    ...
    instance-of v7, v2, Lcom/fasterxml/jackson/databind/deser/BeanDeserializerBase;
    ...
    .line 729
    .local v6, "vi":Lcom/fasterxml/jackson/databind/deser/ValueInstantiator;
    ...
    .line 733
    .local v3, "enclosing":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    if-eqz v3, :cond_55
    ...
    invoke-virtual {v7}, Lcom/fasterxml/jackson/databind/DeserializationConfig;->canOverrideAccessModifiers()Z
    ...
    .line 740
    :cond_4f
    new-instance v7, Lcom/fasterxml/jackson/databind/deser/impl/InnerClassProperty;

    invoke-direct {v7, p2, v1}, Lcom/fasterxml/jackson/databind/deser/impl/InnerClassProperty;-><init>(Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;Ljava/lang/reflect/Constructor;)V
    ...
    .end local v3    # "enclosing":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .end local v4    # "paramTypes":[Ljava/lang/Class;, "[Ljava/lang/Class<*>;"
    .end local v5    # "valueClass":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .end local v6    # "vi":Lcom/fasterxml/jackson/databind/deser/ValueInstantiator;
    .end local p2    # "prop":Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;
    :cond_55
    return-object p2

    .line 734
    .restart local v0    # "bd":Lcom/fasterxml/jackson/databind/deser/BeanDeserializerBase;
    .restart local v1    # "ctor":Ljava/lang/reflect/Constructor;, "Ljava/lang/reflect/Constructor<*>;"
    .restart local v3    # "enclosing":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .restart local v4    # "paramTypes":[Ljava/lang/Class;, "[Ljava/lang/Class<*>;"
    .restart local v5    # "valueClass":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .restart local v6    # "vi":Lcom/fasterxml/jackson/databind/deser/ValueInstantiator;
...
.method public getKnownPropertyNames()Ljava/util/Collection;
    ...
    .line 791
    .local v0, "names":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Object;>;"
...
.method protected injectValues(Lcom/fasterxml/jackson/databind/DeserializationContext;Ljava/lang/Object;)V
    ...
    .line 1255
    .local v0, "injector":Lcom/fasterxml/jackson/databind/deser/impl/ValueInjector;
    invoke-virtual {v0, p1, p2}, Lcom/fasterxml/jackson/databind/deser/impl/ValueInjector;->inject(Lcom/fasterxml/jackson/databind/DeserializationContext;Ljava/lang/Object;)V
    ...
    .line 1257
    .end local v0    # "injector":Lcom/fasterxml/jackson/databind/deser/impl/ValueInjector;
    :cond_e
    return-void
.end method
...
.method public resolve(Lcom/fasterxml/jackson/databind/DeserializationContext;)V
    ...
    .line 415
    .local v18, "prop":Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;
    invoke-virtual/range {v18 .. v18}, Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;->hasValueTypeDeserializer()Z
    ...
    .line 416
    invoke-virtual/range {v18 .. v18}, Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;->getValueTypeDeserializer()Lcom/fasterxml/jackson/databind/jsontype/TypeDeserializer;

    move-result-object v20

    .line 417
    .local v20, "typeDeser":Lcom/fasterxml/jackson/databind/jsontype/TypeDeserializer;
    invoke-virtual/range {v20 .. v20}, Lcom/fasterxml/jackson/databind/jsontype/TypeDeserializer;->getTypeInclusion()Lcom/fasterxml/jackson/annotation/JsonTypeInfo$As;
    ...
    .end local v18    # "prop":Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;
    .end local v20    # "typeDeser":Lcom/fasterxml/jackson/databind/jsontype/TypeDeserializer;
    :cond_61
    const/16 v22, 0x0

    .line 429
    .local v22, "unwrapped":Lcom/fasterxml/jackson/databind/deser/impl/UnwrappedPropertyHandler;
    move-object/from16 v0, p0
    ...
    check-cast v17, Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;

    .line 430
    .local v17, "origProp":Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;
    move-object/from16 v18, v17

    .line 432
    .restart local v18    # "prop":Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;
    invoke-virtual/range {v18 .. v18}, Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;->hasValueDeserializer()Z
    ...
    .line 436
    invoke-virtual/range {v18 .. v18}, Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;->getType()Lcom/fasterxml/jackson/databind/JavaType;
    ...
    invoke-virtual {v0, v1, v6, v2}, Lcom/fasterxml/jackson/databind/deser/BeanDeserializerBase;->findDeserializer(Lcom/fasterxml/jackson/databind/DeserializationContext;Lcom/fasterxml/jackson/databind/JavaType;Lcom/fasterxml/jackson/databind/BeanProperty;)Lcom/fasterxml/jackson/databind/JsonDeserializer;
    ...
    instance-of v6, v0, Lcom/fasterxml/jackson/databind/deser/impl/ManagedReferenceProperty;
    ...
    .line 459
    .local v21, "u":Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;
    if-eqz v21, :cond_f8
    ...
    .line 462
    new-instance v22, Lcom/fasterxml/jackson/databind/deser/impl/UnwrappedPropertyHandler;

    .end local v22    # "unwrapped":Lcom/fasterxml/jackson/databind/deser/impl/UnwrappedPropertyHandler;
    invoke-direct/range {v22 .. v22}, Lcom/fasterxml/jackson/databind/deser/impl/UnwrappedPropertyHandler;-><init>()V

    .line 464
    .restart local v22    # "unwrapped":Lcom/fasterxml/jackson/databind/deser/impl/UnwrappedPropertyHandler;
    :cond_ce
    ...
    invoke-virtual {v6, v0}, Lcom/fasterxml/jackson/databind/deser/impl/BeanPropertyMap;->remove(Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;)V

    goto :goto_6b

    .line 440
    .end local v21    # "u":Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;
    :cond_df
    invoke-virtual/range {v18 .. v18}, Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;->getValueDeserializer()Lcom/fasterxml/jackson/databind/JsonDeserializer;
    ...
    invoke-virtual {v0, v15, v1, v6}, Lcom/fasterxml/jackson/databind/DeserializationContext;->handlePrimaryContextualization(Lcom/fasterxml/jackson/databind/JsonDeserializer;Lcom/fasterxml/jackson/databind/BeanProperty;Lcom/fasterxml/jackson/databind/JavaType;)Lcom/fasterxml/jackson/databind/JsonDeserializer;

    move-result-object v10

    .line 446
    .local v10, "cd":Lcom/fasterxml/jackson/databind/JsonDeserializer;, "Lcom/fasterxml/jackson/databind/JsonDeserializer<*>;"
    if-eq v10, v15, :cond_9f
    ...
    .restart local v21    # "u":Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;
    :cond_f8
    move-object/from16 v0, p0
    ...
    invoke-virtual {v6, v0}, Lcom/fasterxml/jackson/databind/deser/impl/BeanPropertyMap;->replace(Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;)V
    ...
    .line 482
    .restart local v20    # "typeDeser":Lcom/fasterxml/jackson/databind/jsontype/TypeDeserializer;
    invoke-virtual/range {v20 .. v20}, Lcom/fasterxml/jackson/databind/jsontype/TypeDeserializer;->getTypeInclusion()Lcom/fasterxml/jackson/annotation/JsonTypeInfo$As;
    ...
    .line 495
    .end local v17    # "origProp":Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;
    .end local v18    # "prop":Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;
    .end local v20    # "typeDeser":Lcom/fasterxml/jackson/databind/jsontype/TypeDeserializer;
    .end local v21    # "u":Lcom/fasterxml/jackson/databind/deser/SettableBeanProperty;
    :cond_13e
    ...
    .line 515
    .local v19, "td":Lcom/fasterxml/jackson/databind/jsontype/TypeDeserializer;
    if-nez v19, :cond_1e9
    ...
    .end local v12    # "dd":Lcom/fasterxml/jackson/databind/JsonDeserializer;, "Lcom/fasterxml/jackson/databind/JsonDeserializer<Ljava/lang/Object;>;"
    .end local v19    # "td":Lcom/fasterxml/jackson/databind/jsontype/TypeDeserializer;
    :cond_205
    if-eqz v16, :cond_214
